...
public class ProductListRequest {
    ...
    /**
     * Constructs a ProductListRequest with the given pagination values and optional filters.
     *
     ...
     * @param status     optional product status to filter results (e.g., "PUBLISHED", "DRAFT")
     */
     ...
     *
     * @return the limit (number of items per page); must be greater than or equal to 1
     */
    public int getLimit() {
        return limit;
    }
     ...
     *
     * @return the category identifier to filter products by, or {@code null} if unspecified
     */
     ...
     *
     * @param brandId the brand's identifier, or {@code null} to clear the brand filter
     */
     ...
     *
     * @return the status string (e.g. `PUBLISHED`, `DRAFT`) or `null` if no status filter is set
     */
     ...
     *
     * @param status the product status to filter by (e.g. "PUBLISHED", "DRAFT"); may be null to clear the filter
     */
