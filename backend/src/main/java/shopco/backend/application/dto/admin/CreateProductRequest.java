...
public class CreateProductRequest {
    ...
    public CreateProductRequest(String name, String slug, String description, String brandId,
            String categoryId, String defaultImage, String seoMetaTitle, String seoMetaDesc,
            ProductStatus status, List<String> tagIds) {
        this.name = name;
        this.slug = slug;
